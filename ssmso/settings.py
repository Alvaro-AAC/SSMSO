"""
Django settings for ssmso project.
...
SECRET_KEY = 'django-insecure-=9v@+%$nf^_sdqo(qz#e5np#iufn4g)nb+b+f9(w!mc8a4j6-+'
...
WSGI_APPLICATION = 'ssmso.wsgi.application'
